...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('form', 'input', 'assets/server.php').init();
});
...
/*#__PURE__*/
function () {
  function Form(forms, inputs, url) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          postData(_this.url, formData).then(function (res) {
            console.log(res);
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      ...
      this.slides.forEach(function (slide) {
        if (slide.tagName == 'BUTTON') {
          _this2.container.appendChild(_this2.prev);

          _this2.container.appendChild(_this2.next);
        }
      });
      this.decorizeSlides();
    }
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        _this3.slides.forEach(function (slide) {
          if (slide.tagName == 'BUTTON') {
            active = _this3.slides[_this3.slides.length - 3];
          } else {
            active = _this3.slides[_this3.slides.length - 1];
          }
        });
    ...
    value: function init() {
      ...
      if (this.autoplay) {
        ...
        (this.next || this.prev).addEventListener('click', function () {
          return clearInterval(interval);
        });
      }
    }
